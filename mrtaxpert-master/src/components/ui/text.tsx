...
const textVariant = cva("text-foreground/80", {
  variants: {
    size: {
      xs: "text-[clamp(.75rem,1.5vw,.75rem)]",
      sm: "text-[clamp(.75rem,1.5vw,.875rem)]",
      md: "text-[clamp(.75rem,1.75vw,1rem)]",
      lg: "text-[clamp(.875rem,2.5vw,1.125rem)]",
      xl: "text-[clamp(1.375rem,2.5vw,1.875rem)]",
      "2xl": "text-[clamp(1.375rem,2.5vw,2.875rem)]",
    },
  },
  defaultVariants: {
    size: "md",
